...
export default function Home() {
    ...
    // We remove the unused navRef since we aren't doing the mouse effect on nav anymore
        ...
        <main className={styles.main}>
            ...
            >
                <div className={navStyles.glassNav}>
                    ...
                    <div className={navStyles.navBackgroundContainer}>
                        <motion.div
                            className={navStyles.activePill}
                            layoutId="activePill"
                            animate={{
                                x: activeTab === 'vault' ? 0 : '100%',
                            }}
